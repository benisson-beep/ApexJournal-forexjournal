...
export const LandingFooter: React.FC = () => {
  return (
    <footer className="border-t border-white/10 bg-black pt-16 pb-12 px-6 text-slate-400">
      <div className="max-w-[1280px] mx-auto space-y-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="flex items-center gap-2 bg-[#000000] border border-white/15 hover:border-white/40 px-3.5 py-1.5 rounded-lg transition-all group"
            >
